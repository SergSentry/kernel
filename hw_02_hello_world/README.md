...
Написан модуль **hello**

Создан файл с требуемыми и дополнительными целями

Написаны юнит-тесты для тестирования модуля 

Выполнение скрипта тестирования

![Выполнение скрипта тестирования](./img/1.png "Выполнение скрипта тестирования")
