...
from test.modules.spinlock_module import SpinlockModule
...
class TestSpinlockModule(unittest.TestCase):
    ...
    def test_lsmod(self):
        ...
        '''
        with SpinlockModule(path=MODULE_PATH) as spin_module:
            self.assertTrue(spin_module.has_loaded())
    ...
    def test_init_message(self):
        ...
        '''
        with SpinlockModule(path=MODULE_PATH) as spin_module:
            _, func, msg = next(Dmesg.get_messages(SpinlockModule.MODULE_NAME, last=1))

            self.assertEqual("ex_spinlock_init", func.strip())
    ...
    def test_exit_message(self):
        ...
        self.assertEqual("ex_spinlock_exit", func.strip())
    ...
    def test_permission(self):
        ...
        with SpinlockModule(path=MODULE_PATH) as spin_module:
            param = {
                spin_module._get_parameter_path(SpinlockModule.MODULE_PARAM_CMD): 0o640,
                spin_module._get_parameter_path(SpinlockModule.MODULE_PARAM_CMD_STATUS): 0o640,
                spin_module._get_parameter_path(SpinlockModule.MODULE_PARAM_CMD_RESULT): 0o640,
            }
    ...
    def test_unknown_cmd_empty(self):
        ...
        '''
        with SpinlockModule(path=MODULE_PATH) as spin_module:
            status, result = spin_module.execute("")
    ...
    def test_unknown_cmd_start_with_space(self):
        ...
        with SpinlockModule(path=MODULE_PATH) as spin_module:
            with self.assertRaises(OSError):
                 status, result = spin_module.execute(" "+SpinlockModule.MODULE_CMD_RUN)
    ...
    def test_unknown_cmd_other(self):
        ...
        with SpinlockModule(path=MODULE_PATH) as spin_module:
            with self.assertRaises(OSError):
                 status, result = spin_module.execute("simsalabim")
    ...
    def test_run(self):
        ...
        ms_gen = Dmesg.get_messages(SpinlockModule.MODULE_NAME, last=3)
    ...
    def test_stop_before_run(self):
        ...
        '''
        with SpinlockModule(path=MODULE_PATH) as spin_module:
              status, result = spin_module.execute(SpinlockModule.MODULE_CMD_STOP)
              self.assertEqual(0, status)
              self.assertEqual(0, result)
    ...
    def test_work(self):
        ...
        ms_gen = Dmesg.get_messages(SpinlockModule.MODULE_NAME, last=msg_counter)
